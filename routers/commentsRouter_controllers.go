...
func init() {
	...
	beego.GlobalControllerRouter["driiip-api/controllers:DpUserDeviceController"] = append(beego.GlobalControllerRouter["driiip-api/controllers:DpUserDeviceController"],
		beego.ControllerComments{
			Method: "Post",
			Router: `/`,
			AllowHTTPMethods: []string{"post"},
